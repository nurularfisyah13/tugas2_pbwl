          ...
          <table class="table table-bordered">
                  ...
                  <?php $no=1; ?> 
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url; ?>/user/edit/<?= $row['user_id'] ?>" class="badge badge-info ">Edit</a> <a href="<?= base_url; ?>/user/hapus/<?= $row['user_id'] ?>" class="badge badge-danger" onclick="return confirm('Hapus data?');">Hapus</a>
                      </td>
                    </tr>
                    <?php $no++; endforeach; ?>
                  </tbody>
